...
$kerjaan_home = "SELECT * FROM kerjaan join kategori_kerjaan on kerjaan.id_kategori = kategori_kerjaan.id_kategori LIMIT 4";
$query_kerjaan_home = mysqli_query($koneksi, $kerjaan_home);
$data_kerjaan_home = mysqli_fetch_array($query_kerjaan_home);
